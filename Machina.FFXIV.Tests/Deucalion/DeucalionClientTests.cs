...
namespace Machina.FFXIV.Tests.Deucalion
{
    ...
    public class DeucalionClientTests
    {
        ...
        public void DeucalionClientTest()
        {
            ...
            sut.MessageReceived = (byte[] data, DeucalionClient.DeucalionChannel _) => { receivedData = data; };
            sut.MessageSent = (byte[] data, DeucalionClient.DeucalionChannel _) => { sentData = data; };
